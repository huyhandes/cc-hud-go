...
- **IMPORTANT:** Use `codemap` bash command to generate an overview of the codebase, then generate a summary at `./docs/codebase-summary.md` based on the output. Options: `codemap .` (tree), `codemap --deps .` (dependencies).
...
2. **IMPORTANT:** Run `codemap .` to generate codebase overview and create `./docs/codebase-summary.md` based on the output
