...
# STEP 2: Execute fetch_docs.py script (handles URL construction automatically)
...
python scripts/detect_topic.py "How do I use date picker in shadcn?"
# {"topic": "date", "library": "shadcn/ui", "isTopicSpecific": true}

python scripts/fetch_docs.py "How do I use date picker in shadcn?"
...
```bash
# Execute scripts
python scripts/detect_topic.py "Temporal workflow patterns in Go"
# {"topic": "workflow", "library": "temporal-go", "isTopicSpecific": true}

python scripts/fetch_docs.py "Temporal workflow patterns in Go"
# Script fetches: context7.com/temporalio/sdk-go/llms.txt?topic=workflow
# Returns: 3-4 URLs

# Process URLs via 2 Explorer agents
# Present workflow patterns
```
